 ...
 * the License.
 */
package istio.fake.base.querymap;
...
public class FieldQueryMapEncoder implements QueryMapEncoder {
  ...
  @Override
  public Map<String, Object> encode(Object object) throws FakeException {
    try {
      ...
      throw new FakeException("Failure encoding object into query map", e);
    }
  }
