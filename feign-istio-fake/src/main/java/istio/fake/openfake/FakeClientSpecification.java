 ...
 */
public class FakeClientSpecification implements NamedContextFactory.Specification {

	private String name;

	private Class<?>[] configuration;

	FakeClientSpecification() {
	}

	FakeClientSpecification(String name, Class<?>[] configuration) {
		this.name = name;
	...
	public boolean equals(Object o) {
		...
		FakeClientSpecification that = (FakeClientSpecification) o;
