...
public class SingleParameterWriter extends AbstractWriter {
  ...
  protected void write (Output output, String key, Object value) throws FakeException {
    val string = new StringBuilder()
        .append("Content-Disposition: form-data; name=\"").append(key).append('"').append(ContentProcessor.CRLF)
        .append("Content-Type: text/plain; charset=").append(output.getCharset().name()).append(ContentProcessor.CRLF)
