...
import istio.fake.FakeClientsRegistrar;
import istio.fake.configuration.FakeAutoConfiguration;
...
@Documented
@Import(FakeClientsRegistrar.class)
@ImportAutoConfiguration({FakeAutoConfiguration.class, FakeClientsConfiguration.class})
